...
The project is an experimental v0.1 validation build. It is not a compliance certification, a malware verdict engine, or a complete view of systems that are not instrumented.
...
```text
OTLP JSON / declared observations
              |
              v
      evidence normalizer
              |
